...
metaparams <-
  expand_grid(
    outcome = factor(c("postest", "emergency", "covidemergency", "covidadmitted", "covidcritcare", "coviddeath","noncovidadmitted", "noncoviddeath","admitted_unplanned","pericarditis","myocarditis","fracture")),
