...
if (Sys.getenv("OPENSAFELY_BACKEND") %in% c("", "expectations")) {
  ...
  data_studydef_dummy <- read_feather(here("output", glue("input_control_potential_{matching_round_date}.feather"))) %>%
...
write_rds(data_control_potential, here("output", "data", glue("data_control_potential{matching_round}_{agegroup}.rds")), compress = "gz")
