...
inclusion_variables = generate_inclusion_variables(
    baseline_date=f"covid_vax_any_{vaxn}_date"
)
############################################################
## matching variables
from variables_matching import generate_matching_variables

matching_variables = generate_matching_variables(
    baseline_date=f"covid_vax_any_{vaxn}_date"
)
############################################################
## outcome variables
...
outcome_variables = generate_outcome_variables(
    baseline_date=f"covid_vax_any_{vaxn}_date", product_name=product_name
)
############################################################
