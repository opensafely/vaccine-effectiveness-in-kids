    ...
    """,
      ...
      """,
                    ...
                    astrxm2_1=patients.with_these_medications(
                        ...
                        returning="binary_flag",
                        between=[
                            f"{baseline_date} - 60 days",
                            f"{baseline_date} - 31 days",
                        ],
                    ),
                ),
      ...
      """,
          ...
          """,
                        ...
                        preg=patients.with_these_clinical_events(
                            ...
                            between=[
                                f"{baseline_date} - 308 days",
                                f"{baseline_date} - 1 days",
                            ],
                        ),
    ...
    """,
        ...
        cev=patients.satisfying(
            ...
            less_vulnerable=patients.with_these_clinical_events(
                codelists.nonshield,
                between=[
                    "date_severely_clinically_vulnerable + 1 day",
                    f"{baseline_date} - 1 day",
                ],
            ),
        ),
